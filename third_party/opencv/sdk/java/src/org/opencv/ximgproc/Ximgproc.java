...
public class Ximgproc {
    ...
    public static GuidedFilter createGuidedFilter(Mat guide, int radius, double eps, double scale) {
        return GuidedFilter.__fromPtr__(createGuidedFilter_0(guide.nativeObj, radius, eps, scale));
    }
    ...
    public static GuidedFilter createGuidedFilter(Mat guide, int radius, double eps) {
        return GuidedFilter.__fromPtr__(createGuidedFilter_1(guide.nativeObj, radius, eps));
    }
    ...
    public static void guidedFilter(Mat guide, Mat src, Mat dst, int radius, double eps, int dDepth, double scale) {
        guidedFilter_0(guide.nativeObj, src.nativeObj, dst.nativeObj, radius, eps, dDepth, scale);
    }
    ...
    public static void guidedFilter(Mat guide, Mat src, Mat dst, int radius, double eps, int dDepth) {
        guidedFilter_1(guide.nativeObj, src.nativeObj, dst.nativeObj, radius, eps, dDepth);
    }
    ...
    public static void guidedFilter(Mat guide, Mat src, Mat dst, int radius, double eps) {
        guidedFilter_2(guide.nativeObj, src.nativeObj, dst.nativeObj, radius, eps);
    }
    ...
    // C++:  Ptr_GuidedFilter cv::ximgproc::createGuidedFilter(Mat guide, int radius, double eps, double scale = 1.0)
    private static native long createGuidedFilter_0(long guide_nativeObj, int radius, double eps, double scale);
    private static native long createGuidedFilter_1(long guide_nativeObj, int radius, double eps);

    // C++:  void cv::ximgproc::guidedFilter(Mat guide, Mat src, Mat& dst, int radius, double eps, int dDepth = -1, double scale = 1.0)
    private static native void guidedFilter_0(long guide_nativeObj, long src_nativeObj, long dst_nativeObj, int radius, double eps, int dDepth, double scale);
    private static native void guidedFilter_1(long guide_nativeObj, long src_nativeObj, long dst_nativeObj, int radius, double eps, int dDepth);
    private static native void guidedFilter_2(long guide_nativeObj, long src_nativeObj, long dst_nativeObj, int radius, double eps);
